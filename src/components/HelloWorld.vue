...
<template>
  ...
  <!-- Este es el contenedor para las partículas -->
...
<div class="row mt-5">
  ...
  <!-- Nueva fila de tarjetas -->
      <div class="row mt-5">
      <div class="col-md-4">
        <div class="card" style="width: 18rem">
          <img
            src="https://imgs.search.brave.com/dZCf5psFWrRhvrf-JWV7k1uJnqEyB1GJO9e7TRaz3nA/rs:fit:860:0:0:0/g:"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem">
          <img
            src="https://imgs.search.brave.com/fQgXrUJDdol6zRArpXROJoyUUJNou7Cla5uZdgJpuyg/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by91/bWJyZWxsYS13aXRo/LWNoYWlyLWhvdGVs/LXBvb2wtcmVzb3J0/Xzc0MTkwLTQwMDEu/anBnP3NlbXQ9YWlz/X2h5YnJpZA"
            class="card-img-top"
            alt="..."
          />
          <div class="card-body">
    ...
    <div class="section">
      ...
      <p>
        Explora nuestras comodidades de lujo y vive una experiencia única en
        cada rincón de nuestro hotel.
      </p>
    </div>
  </div>
</template>
